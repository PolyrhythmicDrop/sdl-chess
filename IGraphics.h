...
public:
	...
	virtual void addToRenderMap(int layer, std::vector<IDrawable*> objects) = 0;
	...
	virtual void removeFromRenderMap(std::vector<IDrawable*> objects) = 0;
	...
	virtual std::vector<IDrawable*> findInRenderMap(std::vector<IDrawable*> objects) = 0;
